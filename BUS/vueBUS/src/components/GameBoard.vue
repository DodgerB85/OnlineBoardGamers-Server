...
<template>
  <div id="middleArea">
    <transition name="fadeGameBoard">
      <div id="gameBoardAndActions" v-if="!store.performingBoardChange" :style="{
        ...
        <div id="gameBoard" :style="{
          ...
          <template v-if="personal.selectedBoard === rf.BOARD_20A_CAPSTONE">
            ...
            <!-- NEW BUS -->
            <!-- Add a marker -->
            <div v-if="store.actionAreaData[1][0] !== -1" class="actionDisc"
            ...
            <!-- ALTER TIME -->
            <!-- Add a marker -->
            <div v-if="store.actionAreaData[4][0] !== -1" class="actionDisc"
            ...
            <!-- STARTING PLAYER -->
            <!-- Add a marker -->
            <div v-if="store.actionAreaData[6][0] !== -1" class="actionDisc"
            ...
            <!-- PHASE GLOW AREAS -->
            <div v-if="store.gameflow.phase === rf.PHASE_LINE_EXPANSION" class="currentPhaseGlow" :style="{
            ...
            <div v-if="store.gameflow.phase === rf.PHASE_ADD_PAX" class="currentPhaseGlow" :style="{
            ...
            <div v-if="store.gameflow.phase === rf.PHASE_ADD_BLDGS" class="currentPhaseGlow" :style="{
            ...
            <div v-if="store.gameflow.phase === rf.PHASE_ALTER_TIME" class="currentPhaseGlow" :style="{
            ...
            <div v-if="store.gameflow.phase === rf.PHASE_VROM" class="currentPhaseGlow" :style="{
