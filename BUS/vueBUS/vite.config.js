...
export default defineConfig(({ command, mode }) => ({
	...
	base: command === "serve" ? "/static/" : "https://www.onlineboardgamers.com/static/BUS/",

	build: {
		outDir: resolve("../static/BUS/BUSvuedist"),
		//assetsDir: "./assets",
		manifest: false,
		emptyOutDir: true,
		target: "es2015",
		...
		rollupOptions: {
			...
			output: {
				...
				assetFileNames: (assetInfo) => {
					...
					//console.log(new URL(`@static/BUS/images/help/clickPlayers.jpg`, import.meta.url).href)
					//console.log('ABOVE')
					if (/\.(jpg|png|jpe?g|gif|svg|webp|webm|mp3)$/.test(assetInfo.name)) {
						//console.log(new URL(`@static/BUS/images/help/clickPlayers.jpg`, import.meta.url).href)
						if (assetInfo.originalFileNames[0].startsWith("../../static/BUS/images/maps/")) {
							console.log("1111111")
							return `images/maps/[name].${extType}`
						} else if (assetInfo.originalFileNames[0].startsWith("../../static/BUS/images/ships/")) {
							console.log("222222")
							return `images/ships/[name].${extType}`
						} else if (assetInfo.originalFileNames[0].startsWith("../../static/BUS/images/")) {
							console.log("333333")
