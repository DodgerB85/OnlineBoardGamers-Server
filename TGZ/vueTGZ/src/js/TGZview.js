...
export function getImage(image) {
	...
	else if (image === "icon-notebook") return new URL(`../../../static/TGZ/images/icon-notebook.svg`, import.meta.url).href
	else if (image === "icon-scroll") return new URL(`../../../static/TGZ/images/icon-scroll.svg`, import.meta.url).href
	else if (image === "icon-replay") return new URL(`../../../static/TGZ/images/icon-replay.svg`, import.meta.url).href
	else if (image === "icon-box") return new URL(`../../../static/TGZ/images/icon-box.svg`, import.meta.url).href
	// Other imports
	else if (image === "loading-bar-black") return new URL(`../../../static/TGZ/images/loading-bar-black.gif`, import.meta.url).href
	else if (image === "rot_anticlockwise") return new URL(`../../../static/TGZ/images/rot_anticlockwise.svg`, import.meta.url).href
	else if (image === "rot_clockwise") return new URL(`../../../static/TGZ/images/rot_clockwise.svg`, import.meta.url).href
	else if (image === "TGZ_box") return new URL(`../../../static/TGZ/images/TGZ_box.jpg`, import.meta.url).href
  else if (image === "help_scoring") return new URL(`../../../static/TGZ/images/help_scoring.jpg`, import.meta.url).href
	// Tiles
	else if (image === "map0") return new URL(`../../../static/TGZ/images/map0.jpg`, import.meta.url).href
	...
	/**Craftsman TILES */ else if (image === "res" + String(rf.WATER_TILE) + "_v") return new URL(`../../../static/TGZ/images/res_water_V.jpg`, import.meta.url).href
	...
	/**Cows */ else if (image === "cows1") return new URL(`../../../static/TGZ/images/cows1.jpg`, import.meta.url).href
	...
	/** gods */ else if (image === "god0") return new URL(`../../../static/TGZ/images/g_shadipinyi.jpg`, import.meta.url).href
	...
	/** specs */ else if (image === "spec0") return new URL(`../../../static/TGZ/images/s_herd.jpg`, import.meta.url).href
	...
	/** Techs  */ else if (image === "tech" + rf.WOOD_CARVER_TECH_A) return new URL(`../../../static/TGZ/images/t_wood_carverA.jpg`, import.meta.url).href
