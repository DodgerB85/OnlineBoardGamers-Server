...
if exist "C:\Roger\Programming\OnlineBoardGamers\TGZ\static\TGZ\TGZvuedist\images" (
    rd /s /q "C:\Roger\Programming\OnlineBoardGamers\TGZ\static\TGZ\TGZvuedist\images"
    echo [CLEANUP] Deleted unwanted images directory.
)

REM --- Your existing REMs ---
REM START /B /WAIT cmd /c copy C:\Roger\Programming\MyOG\TGZ\static\TGZ\TGZvuedist\main.js .
REM START /B /WAIT cmd /c javascript-obfuscator.cmd main.js
REM copy main-obfuscated.js ..\static\TGZ\TGZvuedist\main.js
