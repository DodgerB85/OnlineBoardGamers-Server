...
class KFW_Game(models.Model):
    ...
    # winner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="KFWgame_winner_relName", blank=True)
    ...
    # This holds the meeple bag and skills bag. It starts as [ [40,40,40,0], [16,16,16]]
    ...
    # relatedTournament = models.ForeignKey(KFW_Tournament, on_delete=models.SET_NULL, null=True, blank=True, related_name="tournament_relName_KFW")
