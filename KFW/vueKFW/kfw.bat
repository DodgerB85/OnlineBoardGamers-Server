...
if exist "C:\Roger\Programming\OnlineBoardGamers\KFW\static\KFW\KFWvuedist\images" (
    rd /s /q "C:\Roger\Programming\OnlineBoardGamers\KFW\static\KFW\KFWvuedist\images"
    echo [CLEANUP] Deleted unwanted images directory.
)

REM --- Your existing REMs ---
REM START /B /WAIT cmd /c copy C:\Roger\Programming\MyOG\KFW\static\KFW\KFWvuedist\main.js .
REM START /B /WAIT cmd /c javascript-obfuscator.cmd main.js
REM copy main-obfuscated.js ..\static\KFW\KFWvuedist\main.js
