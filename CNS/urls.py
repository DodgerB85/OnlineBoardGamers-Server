...
urlpatterns = [
    ...
    path('<int:game_id>/spoilerFree/', views.showCNSgame, {'spoilerFree': True}, name='showCNSgameSpoilerFree'),
    path('<int:game_id>/replay/<int:replayStep>/', views.showCNSgame, {'spoilerFree': True}, name='showCNSreplayStep'),
#
