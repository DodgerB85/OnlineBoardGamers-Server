...
<template>
  <TopMenu />
  <div id="wholeMiddleArea" :class="store.topMenuViews.showReplay ? 'greyBackground' : 'normalBackground'" :style="{
          ...
          <template v-if="!store.topMenuViews.generatingReplay">
            <div id="mainAreaLessHistory">
              ...
              <template v-if="personal.canPlay() || store.topMenuViews.showReplay">
                <ResourceArea
                  v-if="store.gameflow.phase === rf.PHASE_PRODUCTION || store.gameflow.phase === rf.PHASE_NETWORK || store.gameflow.phase === rf.PHASE_STORE_RES" />
