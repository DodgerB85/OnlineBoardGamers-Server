...
'use strict';
{
  ...
  const newcatalog = {
    "%(carAmount)s Car for $%(eachSaleAmount)s": [
      "%(carAmount)s EINMAL DIE Car for $%(eachSaleAmount)s",
      "%(carAmount)s ZWEIMAL DIE Cars, Jeden Fur $%(eachSaleAmount)s"
    ],
    ...
    "Filter": "Filter",
    "Hide": "Ausblenden",
    "House %(houseNum)s sold %(burgSold)s burgers and %(beerSold)s beers": " %(burgSold)s burgers UND %(beerSold)s beers warren von haus %(houseNum)s gesolltet",
    "January": "Januar",
    "July": "Juli",
    "June": "Juni",
    "March": "M\u00e4rz",
