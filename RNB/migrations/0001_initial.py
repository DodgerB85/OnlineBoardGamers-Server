            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="RNBallPlayersRelName", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "creator",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="RNBinvitedPlayersRelName",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="RNBkickedPlayersRelName",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="RNBmissingPlayersRelName",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="RNBplayersWithChatNotificationName",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="RNBgame_winner_relName",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
