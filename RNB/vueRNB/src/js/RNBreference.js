...
export const MOVE_FLY = 6
export const MOVE_TAXI = 7
...
// Air transporters (planes). Used for cap logic so planes count toward the global
// 8-transporter limit but bypass the land/sea 5-cap.
export const AIR_TRANSPORTERS = [PLANE]
// Sentinel "type" for getTransportersByPlayerIndexandType so planes can be queried
// like LAND_TYPE / WATER_TYPE without disturbing those groups.
export const AIR_TYPE = PLANE
...
export const ALL_TRANSPORTER_FACTORIES = [BLDG_WAGON_FACTORY, BLDG_TRUCK_FACTORY, BLDG_RAFT_FACTORY, BLDG_ROWBOAT_FACTORY, BLDG_STEAMER_FACTORY, BLDG_AEROPORT]
