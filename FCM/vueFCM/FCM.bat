...
if exist "C:\Roger\Programming\OnlineBoardGamers\FCM\static\FCM\FCMvuedist\images" (
    rd /s /q "C:\Roger\Programming\OnlineBoardGamers\FCM\static\FCM\FCMvuedist\images"
