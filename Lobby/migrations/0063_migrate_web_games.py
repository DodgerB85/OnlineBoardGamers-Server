...
def migrate_web_games(apps, schema_editor):
    ...
    for web_game in web_games:
        ...
        new_game = Game.objects.create(
            ...
            startingMap=web_game.startingMap if hasattr(web_game, 'startingMap') else '',
            startingOptions=web_game.startingOptions,
            statsExcludeConsent=web_game.statsExcludeConsent if hasattr(web_game, 'statsExcludeConsent') else None,
            deleteGameVotes=web_game.deleteGameVotes if hasattr(web_game, 'deleteGameVotes') else None,
            activeVotes=web_game.activeVotes if hasattr(web_game, 'activeVotes') else None,
