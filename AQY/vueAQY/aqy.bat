...
if exist "C:\Roger\Programming\OnlineBoardGamers\AQY\static\AQY\AQYvuedist\images" (
    rd /s /q "C:\Roger\Programming\OnlineBoardGamers\AQY\static\AQY\AQYvuedist\images"
    echo [CLEANUP] Deleted unwanted images directory.
)

REM --- Your existing REMs ---
REM START /B /WAIT cmd /c copy C:\Roger\Programming\MyOG\AQY\static\AQY\AQYvuedist\main.js .
REM START /B /WAIT cmd /c javascript-obfuscator.cmd main.js
REM copy main-obfuscated.js ..\static\AQY\AQYvuedist\main.js
