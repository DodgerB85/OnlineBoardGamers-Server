...
const copyMessage = ref('https://www.onlineboardgamers.com/AQY/110/replay/5 Copied to Clipboard');
...
async function localCopyGameToPracticeGame2() {
    store.topMenuViews.rewindErrorText = "Not implemented yet"
    /*let copyStep = 0
    ...
    //if (result.response) spinoffSuccessText.value = 'Game Created. View in Lobby or click <a href="/TGZ/' + String(result.newID) + '" target="_blank"/>Here</a>'
...
function copyToClipboard() {
    const textToCopy =
        "https://www.onlineboardgamers.com/AQY/" +
