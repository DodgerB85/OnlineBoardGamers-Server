        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "chatData",
                    models.TextField(
                        default='{"name":"WelcomeBot","timestamp":1676264378000,"message":"Welcome to Horseless Carriage Online!=-NEWLINE-==-NEWLINE-=If you have any suggestions, questions or comments, then please do contact the webmaster at the email address in Contact (top right in the lobby). Thanks!"},'
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="HCallPlayersRelName", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "creator",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="HCinvitedPlayersRelName",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="HCkickedPlayersRelName",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="HCmissingPlayersRelName",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
