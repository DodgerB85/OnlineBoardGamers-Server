    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                default='{"name":"WelcomeBot","timestamp":1690432606000,"message":"Welcome to Horseless Carriage Online!=-NEWLINE-==-NEWLINE-=If you have any suggestions, questions or comments, then please do contact the webmaster at the email address in Contact (top right in the lobby). Thanks!"},'
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="startingPlayersRelName_HC",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
